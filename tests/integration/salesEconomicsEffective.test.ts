...
function expectedFrom(rows: Row[]) {
  ...
  return {
    ...
    // Two-step form-submission rates: MEAN of each (identical treatment).
...
describe('Effective Sales Economics Endpoint', () => {
  ...
  const contributors: Row[] = [
    ...
    { lifetimeRevenueUsd: 2000, replyToMeetingPct: 20, visitToMeetingPct: 16, meetingToClosePct: 40, visitToSignupPct: 60, signupToPaidClientPct: 10, visitToPaidClientPct: 9, replyToPaidClientPct: 45, visitToFormSubmissionPct: 42, formSubmissionToPaidClientPct: 28 },
    { lifetimeRevenueUsd: 500000, replyToMeetingPct: 40, visitToMeetingPct: 20, meetingToClosePct: 50, visitToSignupPct: 80, signupToPaidClientPct: 30, visitToPaidClientPct: 12, replyToPaidClientPct: 50, visitToFormSubmissionPct: 60, formSubmissionToPaidClientPct: 35 },
  ];
