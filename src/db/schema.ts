...
export const brandOffers = pgTable("brand_offers", {
	...
	// offer sells, so it is stated once per offer. NULL = never stated: nothing
	// defaults, averages or borrows one. Migration 0071 carried it over from the
	// retired per-funnel store (dropped by 0074).
