...
import { orgRouter as salesRepOrgRoutes } from './routes/sales-rep.routes';
import { orgRouter as brandFunnelRatesOrgRoutes, internalRouter as brandFunnelRatesInternalRoutes } from './routes/brand-funnel-rates.routes';
import { orgRouter as legRatesOrgRoutes, internalRouter as legRatesInternalRoutes } from './routes/leg-rates.routes';
...
app.use('/orgs', apiKeyAuth, requireOrgId, salesRepOrgRoutes);
