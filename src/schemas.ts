...
// A name a CALLER SUPPLIED: at most 60 characters, no word limit, unique within
// the brand. The customer's own word for their own proposition — a hyphenated or
// three-word name is theirs to choose, and over the limit is refused rather than
// cut, because the surface collecting it shows a character counter first.
...
registry.registerPath({
  ...
  description:
    ...
    `The name is at most ${SUPPLIED_OFFER_NAME_MAX_CHARS} characters, with no word limit, ` +
  ...
  responses: {
    ...
    400: { description: 'Invalid brand ID, or a blank name, or a name over the character limit' },
    403: { description: "Brand does not belong to the caller's org" },
    404: { description: 'Brand not found' },
...
registry.registerPath({
  ...
  description:
    `Rename it. The ${SUPPLIED_OFFER_NAME_MAX_CHARS}-character limit applies exactly as it does on ` +
    'create, there is no word limit, and the name stays unique within ' +
  ...
  responses: {
    ...
    400: { description: 'Invalid ID, or a blank name, or a name over the character limit' },
    403: { description: "Brand does not belong to the caller's org" },
    404: { description: 'No such brand, or no such offer on it' },
