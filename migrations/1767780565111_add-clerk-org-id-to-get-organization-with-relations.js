...
/**
 * Migration: Add clerk_organization_id to get_organization_with_relations output
 * 
 * CHANGE: Add org_clerk_organization_id column at the end of the output
 */
...
exports.up = (pgm) => {
  ...
  pgm.sql(`
    ...
    RETURNS TABLE (
      ...
      org_clerk_organization_id TEXT
    )
    LANGUAGE sql
    AS $$
      SELECT
        ...
        org.clerk_organization_id AS org_clerk_organization_id
      FROM
