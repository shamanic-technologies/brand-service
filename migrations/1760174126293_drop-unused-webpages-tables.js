 ...
 */
export const up = (pgm) => {
  // Drop unused tables - replaced by scraped_url_firecrawl
  pgm.dropTable('organization_webpages', { ifExists: true });
  pgm.dropTable('webpages', { ifExists: true });
};
...
export const down = (pgm) => {
  // Restore the tables if needed (based on original schema)
