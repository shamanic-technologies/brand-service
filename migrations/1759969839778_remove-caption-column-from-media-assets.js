...
export const up = (pgm) => {
  ...
  pgm.dropColumn('media_assets', 'caption');

  // Recreate the get_shareable_media_assets_by_client_org_id function without caption
  pgm.createFunction(
  ...
  // Recreate the get_non_shareable_media_assets_by_client_org_id function without caption
  pgm.createFunction(
...
export const down = (pgm) => {
  ...
  // Drop and recreate functions with caption
  pgm.dropFunction('get_shareable_media_assets_by_client_org_id', [
    { name: 'client_org_id', type: 'text', mode: 'IN' },
  ]);
  ...
  // Restore the old functions with caption
  pgm.createFunction(
    'get_shareable_media_assets_by_client_org_id',
    [{ name: 'client_org_id', type: 'text', mode: 'IN' }],
    {
