...
export const up = (pgm) => {
  ...
  // Add comment
  pgm.sql(`
    COMMENT ON FUNCTION upsert_organization_linkedin_post IS 'Upserts an organization LinkedIn post from Apify scraper data. Takes organization_id (optional), organization_url (optional), and raw_data (required).';
  `);
};
