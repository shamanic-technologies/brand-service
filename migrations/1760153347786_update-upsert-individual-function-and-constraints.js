...
export const up = (pgm) => {
  ...
  pgm.alterColumn('individuals', 'first_name', { notNull: true });
  pgm.alterColumn('individuals', 'last_name', { notNull: true });

  pgm.alterColumn('organization_individuals', 'organization_role', { notNull: true });
  pgm.alterColumn('organization_individuals', 'belonging_confidence_level', { notNull: true });
  pgm.alterColumn('organization_individuals', 'belonging_confidence_rationale', { notNull: true });
...
export const down = (pgm) => {
  ...
  pgm.alterColumn('individuals', 'first_name', { notNull: false });
  pgm.alterColumn('individuals', 'last_name', { notNull: false });

  pgm.alterColumn('organization_individuals', 'organization_role', { notNull: false });
  pgm.alterColumn('organization_individuals', 'belonging_confidence_level', { notNull: false });
  pgm.alterColumn('organization_individuals', 'belonging_confidence_rationale', { notNull: false });
