...
exports.up = (pgm) => {
  pgm.sql(`
    ...
    RETURNS TABLE (
      ...
      relation_updated_at TIMESTAMP WITH TIME ZONE
    )
    LANGUAGE plpgsql
    AS $$
    DECLARE
    ...
    BEGIN
      ...
      LOOP
        ...
        -- Upsert relation and return everything
        ...
        SELECT
          ...
          o.bio AS organization_bio,
          o.elevator_pitch AS organization_elevator_pitch,
          o.mission AS organization_mission,
          o.story AS organization_story,
          o.offerings AS organization_offerings,
          o.problem_solution AS organization_problem_solution,
          o.goals AS organization_goals,
          o.categories AS organization_categories,
          o.founded_date AS organization_founded_date,
          ...
          o.social_media AS organization_social_media,
          r.id AS relation_id,
          r.source_organization_id AS relation_source_organization_id,
          r.target_organization_id AS relation_target_organization_id,
          r.relation_type,
