/**
 * Migration: Update organization LinkedIn posts and articles functions to include missing columns
 * 
...
exports.up = (pgm) => {
  ...
  // Recreate get_organization_linkedin_posts function with new columns
  pgm.sql(`
  ...
  // Recreate get_organization_linkedin_articles function with new columns
  pgm.sql(`
...
exports.down = (pgm) => {
  // Revert get_organization_linkedin_posts function
  pgm.sql(`
    CREATE OR REPLACE FUNCTION get_organization_linkedin_posts(p_external_organization_id text)
    RETURNS TABLE(
      id uuid,
      linkedin_post_id text,
      linkedin_url text,
  ...
  // Revert get_organization_linkedin_articles function
  pgm.sql(`
    CREATE OR REPLACE FUNCTION get_organization_linkedin_articles(p_external_organization_id text)
    RETURNS TABLE(
      id uuid,
      linkedin_post_id text,
      linkedin_url text,
