...
exports.up = (pgm) => {
  pgm.sql(`
    ...
    RETURNS TABLE (
      ...
      -- Relation fields (no relation_id as the table doesn't have an id column)
    ...
    BEGIN
      ...
      -- 2. Extract relations array: support both direct array and nested db_ready_output
      IF jsonb_typeof(p_input_data) = 'array' THEN
        v_relations_data := p_input_data;
      ELSIF p_input_data ? 'db_ready_output' THEN
        v_relations_data := p_input_data->'db_ready_output';
      ELSE
