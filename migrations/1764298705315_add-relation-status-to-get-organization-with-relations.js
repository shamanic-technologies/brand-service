...
/**
 * Update get_organization_with_relations function to include relation_status
...
exports.up = (pgm) => {
  ...
  // Recreate the function with relation_status added
  pgm.createFunction(
    'get_organization_with_relations',
    [{ name: 'p_external_organization_id', type: 'text', mode: 'IN' }],
    {
      returns:
        'TABLE(org_id uuid, org_name text, org_url text, org_linkedin_url text, org_domain text, org_external_id text, org_created_at timestamptz, org_updated_at timestamptz, relation_target_org_id uuid, relation_target_org_name text, relation_target_org_url text, relation_target_org_linkedin_url text, relation_target_org_domain text, relation_target_org_external_id text, relation_type text, relation_status organization_relation_status, relation_confidence_level text, relation_confidence_rationale text, relation_created_at timestamptz, relation_updated_at timestamptz)',
      language: 'sql',
      replace: true,
    },
    `
...
/**
 * Rollback: restore function without relation_status
 * @param pgm {import('node-pg-migrate').MigrationBuilder}
 * @param run {() => void | undefined}
 * @returns {Promise<void> | void}
 */
exports.down = (pgm) => {
  ...
  // Restore old function without relation_status
  pgm.createFunction(
    'get_organization_with_relations',
    [{ name: 'p_external_organization_id', type: 'text', mode: 'IN' }],
    {
      returns:
        'TABLE(org_id uuid, org_name text, org_url text, org_linkedin_url text, org_domain text, org_external_id text, org_created_at timestamptz, org_updated_at timestamptz, relation_target_org_id uuid, relation_target_org_name text, relation_target_org_url text, relation_target_org_linkedin_url text, relation_target_org_domain text, relation_target_org_external_id text, relation_type text, relation_confidence_level text, relation_confidence_rationale text, relation_created_at timestamptz, relation_updated_at timestamptz)',
      language: 'sql',
      replace: true,
    },
    `
