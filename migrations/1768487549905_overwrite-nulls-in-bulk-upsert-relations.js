 ...
 */
exports.up = (pgm) => {
  // Drop and recreate the function to overwrite values even with nulls (no COALESCE)
  ...
  pgm.sql(`
    ...
    BEGIN
      ...
      LOOP
        ...
        -- Upsert target organization - NOW OVERWRITES WITH NULL VALUES
        ...
        -- Upsert relation - ALSO OVERWRITES WITH NULL VALUES
 ...
 */
exports.down = (pgm) => {
  // Revert to COALESCE behavior (preserve existing values when new is null)
  pgm.sql(`DROP FUNCTION IF EXISTS bulk_upsert_organization_relations(text, text);`);
